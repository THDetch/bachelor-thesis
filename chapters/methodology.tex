...
\end{equation}
where $\lambda$ balances realism and reconstruction accuracy. Following the originally proposed configurations in~\cite{pix2pix_2018}, $\lambda = 100$ is typically used. In addition, supplementary loss components were incorporated, as they demonstrated improved training convergence and led to higher-quality reconstructions (see the ablation study on loss functions in Section~\ref{subsec:ablation_loss}).
