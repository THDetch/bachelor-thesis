% \chapter{Challenges}
\section{Challenges Due to Inherent Model Characteristics}
...
%   \caption{Value ranges across the individual optical bands.}
%   \label{fig:data_ranges}
% \end{figure}
...
\begin{table}[H]
\centering
\caption[Summary statistics of Sentinel-2 optical bands for the winter subset.]{Summary statistics of the Sentinel-2 optical bands across the winter subset. Reported are the global minimum and maximum values, and the 1\textsuperscript{st}, 50\textsuperscript{th} (median), and 99\textsuperscript{th} percentiles.}
