# Main script to (generate) infer images from the preprocessed SEN12-MS dataset with the trained pix2pix model
import os
import sys
import json
import argparse
...
DEFAULT_RESULTS_DIR = "trained-full-copy/generated"
