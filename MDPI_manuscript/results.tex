...
We validate the trained model on both qualitative and quantitative metrics to assess its capability for direct SAR-to-optical image translation. Unlike most prior work that generates only 3–4 RGB bands, the trained Pix2Pix model produces all 13 Sentinel-2 spectral bands.
...
\begin{figure}[H]
    ...
    \textbf{(iii)}~ground-truth Sentinel-2 image. All optical images are depicted in RGB (B4, B4, B2) batch.}
...
\begin{table}[!htbp]
    ...
    \begin{tabular}{lccccc}
        ...
        \midrule
        \textbf{0.888}           & \textbf{32.63}                & \textbf{0.173}              & \textbf{4.41}                 & \textbf{140.72}           & \textbf{233.69}            \\
        \bottomrule
    \end{tabular}
...
Another objective of this work was to assess the model’s ability to reliably reconstruct each optical band individually and to evaluate the uniformity of its accuracy across the spectrum. For this purpose, the model trained on the full winter subset was evaluated separately for all 13 Sentinel-2 bands. The results are summarized in Table~\ref{tab:per_band_validation}.
...
\begin{table}[!htbp]
\centering
\caption{Per-band quantitative validation results. Each Sentinel-2 band’s central wavelength, spectral designation, and native spatial resolution are listed for reference. Best results are highlighted in \textcolor{green!50!black}{green} and worst in \textcolor{red!70!black}{red}.}
...
\begin{table}[!htbp]
    \centering
    \caption[Quantitative results on cloud removal]{Quantitative evaluation on SEN12-MS-CR for cloud removal. Arrows ($\uparrow$ / $\downarrow$) indicate whether higher or lower values denote better performance, respectively.}
    \begin{tabular}{lcccc}
        \toprule
...
%         \centering
%         \setlength{\tabcolsep}{1pt} % Minimal horizontal space between columns
...
%             % ------------------- Row 1 -------------------
%             \textbf{(a)} &
%             \includegraphics[width=0.22\linewidth]{../latex_source_code/img/cloud_removal/sample_000881_sar_pseudo.png} &
%             \includegraphics[width=0.22\linewidth]{../latex_source_code/img/cloud_removal/sample_000881_cloudy_rgb.png} &
%             \includegraphics[width=0.22\linewidth]{../latex_source_code/img/cloud_removal/sample_000881_pred_rgb.png} &
%             \includegraphics[width=0.22\linewidth]{../latex_source_code/img/cloud_removal/sample_000881_true_rgb.png} \\
%             % ------------------- Row 2 -------------------
%             \textbf{(b)} &
%             \includegraphics[width=0.22\linewidth]{../latex_source_code/img/cloud_removal/sample_000683_sar_pseudo.png} &
%             \includegraphics[width=0.22\linewidth]{../latex_source_code/img/cloud_removal/sample_000683_cloudy_rgb.png} &
%             \includegraphics[width=0.22\linewidth]{../latex_source_code/img/cloud_removal/sample_000683_pred_rgb.png} &
%             \includegraphics[width=0.22\linewidth]{../latex_source_code/img/cloud_removal/sample_000683_true_rgb.png} \\
%             % ------------------- Row 3 -------------------
%             \textbf{(c)} &
%             \includegraphics[width=0.22\linewidth]{../latex_source_code/img/cloud_removal/sample_001114_sar_pseudo.png} &
%             \includegraphics[width=0.22\linewidth]{../latex_source_code/img/cloud_removal/sample_001114_cloudy_rgb.png} &
%             \includegraphics[width=0.22\linewidth]{../latex_source_code/img/cloud_removal/sample_001114_pred_rgb.png} &
%             \includegraphics[width=0.22\linewidth]{../latex_source_code/img/cloud_removal/sample_001114_true_rgb.png} \\
%             % ------------------- Row 4 -------------------
%             \textbf{(d)} &
%             \includegraphics[width=0.22\linewidth]{../latex_source_code/img/cloud_removal/sample_000013_sar_pseudo.png} &
%             \includegraphics[width=0.22\linewidth]{../latex_source_code/img/cloud_removal/sample_000013_cloudy_rgb.png} &
%             \includegraphics[width=0.22\linewidth]{../latex_source_code/img/cloud_removal/sample_000013_pred_rgb.png} &
%             \includegraphics[width=0.22\linewidth]{../latex_source_code/img/cloud_removal/sample_000013_true_rgb.png} \\
%             % ------------------- Row 5 -------------------
%             \textbf{(e)} &
%             \includegraphics[width=0.22\linewidth]{../latex_source_code/img/cloud_removal/sample_000150_sar_pseudo.png} &
%             \includegraphics[width=0.22\linewidth]{../latex_source_code/img/cloud_removal/sample_000150_cloudy_rgb.png} &
%             \includegraphics[width=0.22\linewidth]{../latex_source_code/img/cloud_removal/sample_000150_pred_rgb.png} &
%             \includegraphics[width=0.22\linewidth]{../latex_source_code/img/cloud_removal/sample_000150_true_rgb.png} \\
%         \end{tabular}
...
\begin{table}[!htbp]
\centering
\caption[Sentinel-2 MSI spectral bands]{Sentinel-2 MSI spectral bands with central wavelength and spatial resolution}
